...
module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      'shadow-1': '0px 0px 4px rgba(0, 0, 0, 0.12)',
      'shadow-2': '0px 0px 8px 1px rgba(0, 0, 0, 0.16)',
      'shadow-3': '0px 0px 12px 2px rgba(0, 0, 0, 0.18)',
      'shadow-4': '0px 0px 24px 4px rgba(0, 0, 0, 0.2)',
      'shadow-5': '0px 0px 32px 8px rgba(0, 0, 0, 0.22)',
      'shadow-6': '0px 0px 40px 12px rgba(0, 0, 0, 0.24)',
    },
    fontSize: {
      ...getFontPresets([
        ['title-xxl', 32, 'bold'],
